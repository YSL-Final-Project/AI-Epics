...
const SECTIONS: Section[] = [
  {
    ...
    color: '#94a3b8',
    components: [
      { name: 'LiquidLinesBackground',path:'/src/components/LiquidLinesBackground.tsx',    lines: 470, desc: 'Perlin-noise canvas background used on Insights/Compare/Timeline', descZh: 'Perlin 噪声液态流线背景，用于洞察/对比/时间线页' },
      ...
      { name: 'liquidLinesConfig',   path: '/src/components/liquidLinesConfig.ts',          lines: 145, desc: 'Per-page tuning config for LiquidLinesBackground',   descZh: '液态流线背景的分页调参配置' },
      ...
      { name: 'App',                 path: '/src/App.tsx',                                  lines:  87, desc: 'Root router and layout wrapper',                      descZh: '根路由与布局容器' },
      ...
      { name: 'ChapterDots',         path: '/src/components/ChapterDots.tsx',               lines:  74, desc: 'Chapter progress dot indicators',                    descZh: '章节进度圆点指示器' },
  ...
  },
  {
    ...
    color: '#06b6d4',
    components: [
      { name: 'AgentLoop',       path: '/src/components/agentLoop/AgentLoop.tsx',           lines: 1120, desc: 'Interactive 11-step Claude agent loop visualizer', descZh: 'Claude Agent 11 步循环交互可视化' },
      { name: 'DeveloperDNA',    path: '/src/components/interactive/DeveloperDNA.tsx',      lines:  305, desc: 'Developer archetype quiz + radar chart',           descZh: '开发者原型性格测试 + 雷达图' },
      { name: 'AITimeMachine',   path: '/src/components/interactive/AITimeMachine.tsx',     lines:  295, desc: 'Year-based AI tool prediction quiz',               descZh: '年份 AI 工具预测问答' },
      { name: 'CodeQuiz',        path: '/src/components/interactive/CodeQuiz.tsx',          lines:  250, desc: 'AI-generated vs human code quiz',                  descZh: 'AI 代码 vs 人类代码辨别游戏' },
      { name: 'ToolRecommender', path: '/src/components/interactive/ToolRecommender.tsx',   lines:  149, desc: 'Language + experience → AI tool recommender',      descZh: '语言 + 经验 → AI 工具推荐' },
      { name: 'PredictionVote',  path: '/src/components/interactive/PredictionVote.tsx',    lines:  147, desc: 'Community vote on future AI predictions',           descZh: '未来 AI 预测社区投票' },
  ...
  },
  {
    ...
    color: '#f59e0b',
    components: [
      { name: 'LLMArena',         path: '/src/components/compare/LLMArena.tsx',         lines: 699, desc: 'Side-by-side 3-model streaming LLM comparison with i18n answers', descZh: '三模型并排流式对比，答案支持中英双语' },
      { name: 'RacingBarChart',   path: '/src/components/compare/RacingBarChart.tsx',   lines: 426, desc: 'Animated racing bar chart for tool popularity',   descZh: '工具热度动态赛跑柱状图' },
      { name: 'RadarCompare',     path: '/src/components/compare/RadarCompare.tsx',     lines: 273, desc: 'Multi-axis radar chart for tool comparison',       descZh: '多轴雷达图工具对比' },
      { name: 'IDEMarketChart',   path: '/src/components/compare/IDEMarketChart.tsx',   lines: 245, desc: 'IDE market share stacked area chart',              descZh: 'IDE 市场份额堆积面积图' },
      { name: 'ToolCompareTable', path: '/src/components/compare/ToolCompareTable.tsx', lines: 214, desc: 'Scroll-driven spotlight tool comparison',          descZh: '滚动驱动聚光灯工具对比' },
      ...
      { name: 'ComparePage',      path: '/src/pages/ComparePage.tsx',                   lines:  69, desc: 'Compare page layout and section orchestration',    descZh: '对比页面布局编排' },
    ],
  },
  {
    id: 'data',
    ...
    color: '#10b981',
    components: [
      { name: 'CodeGenTab',        path: '/src/components/dataExplorer/CodeGenTab.tsx',        lines: 633, desc: 'AI code generation share + quality chapter', descZh: 'AI 代码生成占比与质量章节' },
      { name: 'StackOverflowTab',  path: '/src/components/dataExplorer/StackOverflowTab.tsx',  lines: 632, desc: 'SO traffic decline + question trend charts', descZh: 'SO 流量下降与问题趋势图' },
      { name: 'AdoptionTab',       path: '/src/components/dataExplorer/AdoptionTab.tsx',       lines: 607, desc: 'AI tool adoption rate multi-chart dashboard', descZh: 'AI 工具采用率多图仪表盘' },
      { name: 'SalaryTab',         path: '/src/components/dataExplorer/SalaryTab.tsx',         lines: 572, desc: 'Developer salary by skill and AI proficiency', descZh: '技能与 AI 熟练度薪资分析' },
      { name: 'DataExplorerTabs',  path: '/src/components/dataExplorer/DataExplorerTabs.tsx',  lines: 302, desc: 'Chapter tab switcher with sticky mini-nav',   descZh: '章节 Tab 切换器与悬浮导航条' },
      { name: 'WorkflowCompareSlider',path:'/src/components/dataExplorer/WorkflowCompareSlider.tsx',lines:237,desc:'Before/after workflow split-view slider',descZh:'工作流前后对比分屏滑块' },
      { name: 'NextChapterCard',   path: '/src/components/dataExplorer/NextChapterCard.tsx',   lines: 102, desc: 'Next-chapter CTA card linking to the next tab', descZh: '下一章 CTA 卡片，串联章节导航' },
      { name: 'DataExplorerPage',  path: '/src/pages/DataExplorerPage.tsx',                    lines:  59, desc: 'Data explorer page wrapper with liquid-lines bg', descZh: '数据探索器页面容器，带液态流线背景' },
      ...
      { name: 'tabConstants',      path: '/src/components/dataExplorer/tabConstants.ts',       lines:  13, desc: 'Shared tab keys and accent colors',             descZh: '共享的 Tab 键与主题色定义' },
    ],
  },
  {
    id: 'evolution',
    ...
    color: '#f97316',
    components: [
      { name: 'ToolEvolutionPage',  path: '/src/pages/ToolEvolutionPage.tsx',                        lines: 279, desc: 'Tool evolution timeline page with 4 eras',  descZh: '4 个时代工具进化时间线' },
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'PagePreviewCard',path: '/src/components/home/PagePreviewCard.tsx', lines: 135, desc: 'Animated page preview card',                  descZh: '动画页面预览卡片' },
  ...
  },
  {
    ...
    color: '#a855f7',
    components: [
      { name: 'DevHistoryPage',  path: '/src/pages/DevHistoryPage.tsx',                     lines: 892, desc: 'Commit timeline + growth charts meta-page',              descZh: '提交时间线 + 增长曲线元页面' },
      { name: 'ArchitectureMap', path: '/src/components/devHistory/ArchitectureMap.tsx',    lines: 640, desc: 'Interactive treemap of the codebase with inline code viewer', descZh: '代码库交互式树形图，内联源码预览' },
    ],
  },
  {
    id: 'timeline',
    ...
    color: '#22d3ee',
    components: [
      { name: 'TimelinePage',      path: '/src/pages/TimelinePage.tsx',                        lines: 165, desc: 'AI tooling history timeline page with liquid-lines bg', descZh: 'AI 工具历史时间线页面，带液态流线背景' },
      { name: 'TimelineEvent',     path: '/src/components/timeline/TimelineEvent.tsx',         lines: 152, desc: 'Individual timeline event card',       descZh: '单个时间线事件卡片' },
      { name: 'TimelineContainer', path: '/src/components/timeline/TimelineContainer.tsx',     lines: 133, desc: 'Timeline scroll container and layout', descZh: '时间线滚动容器布局' },
      { name: 'TimelineDetail',    path: '/src/components/timeline/TimelineDetail.tsx',        lines: 113, desc: 'Expanded event detail panel',          descZh: '展开事件详情面板' },
      { name: 'TimelineFilter',    path: '/src/components/timeline/TimelineFilter.tsx',        lines:  87, desc: 'Timeline category filter bar',         descZh: '时间线分类筛选栏' },
    ],
  },
  {
    id: 'about',
    ...
    components: [
      ...
      { name: 'ContactForm',     path: '/src/components/about/ContactForm.tsx',        lines:  77, desc: 'Contact form with validation',           descZh: '带验证的联系表单' },
      { name: 'DataSourceList',  path: '/src/components/about/DataSourceList.tsx',     lines:  70, desc: 'Data sources list with links',           descZh: '数据来源列表含链接' },
...
const rawModules = import.meta.glob('/src/**/*.{ts,tsx}', { query: '?raw', import: 'default' });
